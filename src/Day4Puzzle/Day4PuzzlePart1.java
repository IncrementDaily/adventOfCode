...
public class Day4PuzzlePart1 {
    ...
    public static void main(String[] args) {
        ...
        //Get the total line count of the datafile
        int lineCount = getDataFileLineCount(dataFilePath);
...
//      int cycleCounter = 0; // <--- this was used for debugging
            ...
            while ((line = readDataLine(dataFileReader)) != null /*&& cycleCounter < lineCount*/){
                ...
                // Turn each unprocessed elf String range into a beginning and end
                ...
                // Run smallerHashSet.retainAll(largerHashSet); if smallerHashSet size doesn't change
                // one range fully contained the other. Thus, do --> fullyContainedCounter++
//                int elf1OrigSize = elf1Assignments.size();
//                int elf2OrigSize = elf2Assignments.size();
//
//                if (elf1OrigSize < elf2OrigSize){
//                    elf1Assignments.retainAll(elf2Assignments);
//                    if (elf1Assignments.size() == elf1OrigSize) fullyContainedCounter++;
//                }
//
//                if (elf2OrigSize < elf1OrigSize){
//                    elf2Assignments.retainAll(elf1Assignments);
//                    if (elf2Assignments.size() == elf2OrigSize) fullyContainedCounter++;
//                }

                // Edge case: same exact assignments
//                if (elf1Assignments.equals(elf2Assignments)) fullyContainedCounter++;
//                counter++;


                /////////// ALTERNATIVE IMPLEMENTATION ////////////////
                // Case: One fully contained by the other
                if (elf1Assignments.containsAll(elf2Assignments)
                        || elf2Assignments.containsAll(elf1Assignments)) fullyContainedCounter++;

                // Edge Case: Both sets exactly equal
                if (elf1Assignments.equals(elf2Assignments)) fullyContainedCounter++;
                /////////// ALTERNATIVE IMPLEMENTATION /////////////////

            }

        System.out.println(fullyContainedCounter);
    }
}
